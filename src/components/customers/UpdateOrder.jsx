...
const UpdateSubOrderStatus = () => {
  ...
  const handleUpdateStatus = async () => {
    ...
    try {
      const response = await fetch(`https://farm-connect-api.onrender.com/api/orders/${subOrderId}/status`, {
        method: 'PATCH',
        headers: {
      ...
      if (response.ok) {
        ...
        switch (response.status) {
          case 400:
            setErrorMessage('Invalid sub-order ID or status.');
            break;
          case 401:
          ...
          case 403:
            ...
            break;
          case 404:
            setErrorMessage('Sub-order not found.');
            break;
          case 500:
  ...
  return (
    <Container>
      <Heading>Update Sub-Order Status</Heading>
      <Input
        type="text"
...
export default UpdateSubOrderStatus;
